<%@ page import="com.lgh.library.Dao.ClassRoomDao" %>
<%@ page import="com.lgh.library.model.Admin" %>
<%@ page import="com.lgh.library.model.ClassRoom" %>
...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" action="./book?action=add" method="post">
            <div class="layui-form-item">
                <label for="username" class="layui-form-label">
                    <span class="x-red">*</span>ISBN</label>
                <div class="layui-input-inline">
                    <input type="text" id="username" name="ISBN" required="" lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="date" id="publicationDate" name="publicationDate" required="" lay-verify="required"
                           autocomplete="off" class="layui-input"></div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="room" id="room" class="contrller">
                        <%
                            ClassRoomDao classRoomDao = new ClassRoomDao();
                            List<ClassRoom> classRooms = classRoomDao.ShowAll();
                            for (ClassRoom list : classRooms) {
                        %>
                        <option value="<%=list.getRoom_id()%>"><%=list.getClassName()%>
                        </option>
                        <%}%>
                    </select>
                </div>
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea placeholder="请输入内容" id="profile" name="profile" class="layui-textarea"></textarea>
                </div>
            </div>
