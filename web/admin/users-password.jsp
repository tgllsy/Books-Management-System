...
<div class="layui-fluid">
    <div class="layui-row">
        ...
        %>
        <form class="layui-form" method="post" action="./users?action=user_repassword">
            <div class="layui-form-item">
                <label for="L_username" class="layui-form-label">用户ID</label>
                <div class="layui-input-inline">
                    <input type="text" id="L_username" name="userid" readonly value="<%=user.getId()%>"
                           class="layui-input"></div>
            </div>
            <div class="layui-form-item">
                <label for="L_repass" class="layui-form-label">
                    <span class="x-red">*</span>旧密码</label><span style="color: red"><%
            ...
            <div class="layui-form-item">
                ...
                <input type="submit" class="layui-btn" value="修改密码">
        </form>
    </div>
</div>
