        ...
        <form class="layui-form" action="borrow?action=add" method="post">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">
                    <span class="x-red">*</span>借阅图书</label>
                <div class="l`ayui-input-inline">
                    <select name="isbn" class="contrller">

                        <%
                            BookDao bookDao = new BookDao();
                            List<Book> books = bookDao.ShowAll(" where status='0'");
                            for (Book list : books) {
                        %>
                        <option value="<%=list.getISBN()%>"><%=list.getTitle()%>
                        </option>
                        <%}%>
