...
<div class="layui-fluid">
    <% ClassRoom classRoom = (ClassRoom) request.getAttribute("room"); %>
    <div class="layui-row">
        <form class="layui-form" method="post" action="classroom?action=update">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="room_id" name="room_id" required="" lay-verify="nikename"
                           autocomplete="off" class="layui-input" readonly value="<%=classRoom.getRoom_id()%>"></div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="class_name" name="class_name" required="" lay-verify="nikename"
                           autocomplete="off" class="layui-input" value="<%=classRoom.getClassName()%>"></div>
            </div>
