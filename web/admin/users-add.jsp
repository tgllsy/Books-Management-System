...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" action="../users?action=user_add" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="radio" id="sex" name="sex" value="男" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">男
                    <input type="radio" id="sex1" name="sex" value="女" required="" lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="date" id="effectiveDate" name="effectiveDate" required="" lay-verify="required"
                           autocomplete="off" class="layui-input"></div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="date" id="expirationDate" name="expirationDate" required="" lay-verify="required"
                           autocomplete="off" class="layui-input"></div>
            </div>
