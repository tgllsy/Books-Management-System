    ...
    <div class="layui-row">
        ...
        <form class="layui-form" action="./users?action=user_update" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="userid" name="userid" required="" lay-verify="nikename"
                           autocomplete="off" class="layui-input" value="<%=user.getId()%>" readonly></div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_username" name="username" required="" lay-verify="nikename"
                           autocomplete="off" class="layui-input" value="<%=user.getUsername()%>"></div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="radio" id="sex" name="sex" value="男" required=""
                           <% if ("男".equals(user.getGender())){%>checked="checked"<%}%> lay-verify="required"
                           autocomplete="off" class="layui-input">男

                    <input type="radio" id="sex1" name="sex" value="女" required=""
                           <% if ("女".equals(user.getGender())){%>checked="checked"<%}%> lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="phone" name="phone" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" value="<%=user.getPhone()%>"></div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="date" id="effectiveDate" name="effectiveDate" value="<%=user.getEffectiveDate()%>"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="date" id="expirationDate" name="expirationDate" value="<%=user.getExpirationDate()%>"
                           required="" lay-verify="required"
                           autocomplete="off" class="layui-input"></div>
            </div>
